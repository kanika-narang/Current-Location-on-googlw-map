...
public class ViewProduct extends AppCompatActivity {
    ...
    public void getdata() {
        ...
        offerdesc = intent.getStringExtra("offerdesc");
      //  lng = Double.parseDouble(intent.getStringExtra("lng"));
      //  Picasso.with(this).load(imageURL).into(im);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("ViewProduct Page") // TODO: Define a title for the content shown.
